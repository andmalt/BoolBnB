    ...
    return (
        <div className="mt-8 mx-4">
            <div className="grid grid-cols-1 md:grid-cols-2">
                <DialogModal errors={errors} setOpenModal={() => setIsOpenModal(false)} openModal={isOpenModal} isContact={isContact} />
                <div className="p-6 mr-2 bg-gradient-to-br from-blue-800 to-[rgb(20,20,20)] sm:rounded-lg">
                    ...
                    <p className="text-normal text-lg sm:text-2xl font-medium text-white mt-2">Compila il form per sottoporre qualsiasi richiesta</p>
                    ...
                    <div className="flex items-center mt-8 text-white ">
                        ...
                        <div className="ml-4 text-md tracking-wide font-semibold w-40">Rome, Italy</div>
                    </div>
                    ...
                    <div className="flex items-center mt-4 text-white ">
                        ...
                        <div className="ml-4 text-md tracking-wide font-semibold w-40">+39 1234567890</div>
                    </div>
