        ...
        <div className="flex flex-col left-0 md:top-0 w-14 hover:w-52 md:w-48 bg-[#0a121e] border-[#29303d] text-white transition-all duration-300 rounded-r-md h-[100vh] fixed z-20">
            ...
            <div className="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
                <ul className="flex flex-col py-4 space-y-1">
                    ...
                    <li>
                        <a href="#" onClick={emailVerification ? () => changeComponents(variablesDashboard.HOUSES) : () => { }} className={classNames("relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#6366f1] dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-600 dark:hover:border-gray-800 pr-6", emailVerification ? "cursor-pointer" : "cursor-not-allowed")}>
                    ...
                    <li>
                        <a href="#" onClick={emailVerification ? () => changeComponents(variablesDashboard.STATISTIC) : () => { }} className={classNames("relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#6366f1] dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-600 dark:hover:border-gray-800 pr-6", emailVerification ? "cursor-pointer" : "cursor-not-allowed")}>
                            <span className="inline-flex justify-center items-center ml-4">
                    ...
                    <li>
                        <a href="#" onClick={emailVerification ? () => changeComponents(variablesDashboard.MESSAGES) : () => { }} className={classNames("relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#6366f1] dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-600 dark:hover:border-gray-800 pr-6", emailVerification ? "cursor-pointer" : "cursor-not-allowed")}>
                            <span className="inline-flex justify-center items-center ml-4">
                    ...
                    <li>
                        <a onClick={() => changeComponents(variablesDashboard.PROFILE)} href="#" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#6366f1] dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-600 dark:hover:border-gray-800 pr-6">
                            <span className="inline-flex justify-center items-center ml-4">
                    ...
                    <li>
                        <a href="#" onClick={() => changeComponents(variablesDashboard.SETTINGS)} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-[#6366f1] dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-600 dark:hover:border-gray-800 pr-6">
                            <span className="inline-flex justify-center items-center ml-4">
