...
const Sidebar = () => {
    return (
        <div className="flex flex-col top-28 left-0 w-14 hover:w-60 md:w-48 bg-black border-blue-800 shadow-[25px_16px_15px_-19px_rgb(30,64,175)] h-full text-white transition-all duration-300 rounded-r-md">
            <div className="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
                <ul className="flex flex-col py-4 space-y-1">
                    <li className="px-5 hidden md:block">
                        <div className="flex flex-row items-center h-8">
                            <div className="text-sm tracking-wide text-blue-800 font-bold uppercase">Principale</div>
                        </div>
                    </li>
                    <li>
