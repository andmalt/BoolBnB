                                    ...
                                    <div className='mx-auto max-w-lg text-white'>
                                        <div className="py-2">
                                            ...
                                            <input value={email} onChange={(e) => setEmail(e.target.value)} placeholder="" type="email"
                                                className="block px-3 py-2 mt-2 rounded-lg w-full bg-[#1d2432] border-2 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:border-[#6366f1] focus:outline-none" />
                                        </div>
                                        <div className="py-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                bg-[#1d2432] border-2 placeholder-gray-600 shadow-md
