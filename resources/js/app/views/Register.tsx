...
const Register = () => {
    ...
    return (
        <div className="container max-w-full mx-auto pb-24 pt-12 px-6 bg-slate-100 dark:bg-[#111827]">
                                    ...
                                    <div className='mx-auto max-w-lg dark:text-white text-black'>
                                        <div className="py-2">
                                            ...
                                            <input value={name} onChange={(e) => setName(e.target.value)} placeholder="" type="text"
                                                className="text-md block px-3 py-2 mt-2 rounded-lg w-full dark:bg-[#1d2432] bg-gray-50 dark:text-white text-black border shadow-sm border-slate-300 dark:border-[#0f1623]  placeholder-gray-600 focus:placeholder-gray-500 focus:border-[#6366f1]  focus:outline-none mb-2" />
                                        </div>
                                        <div className="py-2">
                                        ...
                                        <div className="py-2">
                                            ...
                                            <div className="relative">
                                                <input value={password} onChange={(e) => setPassword(e.target.value)} placeholder="" type={show ? 'password' : 'text'}
                                                    className={`${noRegister ? "border-red-600 " : null}` + "text-md block px-3 mt-2 py-2 rounded-lg w-full dark:bg-[#1d2432] bg-gray-50 dark:text-white text-black border shadow-sm border-slate-300 dark:border-[#0f1623] placeholder-gray-600 focus:placeholder-gray-500 focus:border-[#6366f1]  focus:outline-none"} />
                                        ...
                                        <div className="py-2">
                                            ...
                                            <div className="relative">
                                                <input value={password2} onChange={(e) => setPassword2(e.target.value)} placeholder="" type={show2 ? 'password' : 'text'}
                                                    className={`${noRegister ? "border-red-600 " : null}` + "text-md block px-3 py-2 mt-2 rounded-lg w-full dark:bg-[#1d2432] bg-gray-50 dark:text-white text-black border shadow-sm border-slate-300 dark:border-[#0f1623] placeholder-gray-600 focus:placeholder-gray-500 focus:border-[#6366f1] focus:outline-none"} />
                                                <div className="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
                                                    {
                                                        !show2 ?
